...
function useSetupNestableScrollContextValue() {
    var _a = react_1.useState(true), outerScrollEnabled = _a[0], setOuterScrollEnabled = _a[1];
    var scrollViewSize = react_1.useMemo(function () { return new react_native_reanimated_1.default.Value(0); }, []);
    var scrollableRef = react_1.useRef(null);
    var outerScrollOffset = react_1.useMemo(function () { return new react_native_reanimated_1.default.Value(0); }, []);
    var containerRef = react_1.useRef(null);
    var containerSize = react_1.useMemo(function () { return new react_native_reanimated_1.default.Value(0); }, []);
    var contextVal = react_1.useMemo(function () { return ({
