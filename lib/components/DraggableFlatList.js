...
function DraggableFlatListInner(props) {
    ...
    var renderItem = react_1.useCallback(function (_a) {
        ...
        var passIndexToRenderItem = props.passIndexToRenderItem !== false;
        return (react_1.default.createElement(RowItem_1.default, { item: item, itemKey: key, renderItem: props.renderItem, drag: drag, extraData: props.extraData, passIndexToRenderItem: passIndexToRenderItem }));
...
var MemoizedDraggableFlatListInner = utils_1.typedMemo(DraggableFlatListInner);
    ...
    return (react_1.default.createElement(propsContext_1.default, __assign({}, props),
        react_1.default.createElement(animatedValueContext_1.default, null,
            react_1.default.createElement(refContext_1.default, { flatListRef: ref },
                react_1.default.createElement(MemoizedDraggableFlatListInner, __assign({}, props))))));
}
